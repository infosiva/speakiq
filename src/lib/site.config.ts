...
export const siteConfig: SiteConfig = {
  ...
  faq: [
    ...
    { q: 'How does the pronunciation feedback actually work?',
      a: "When you speak, SpeakIQ transcribes what you said and compares it word-by-word against the expected phrase. It scores the attempt 0-100, flags the specific words or sounds that were off, and gives you one concrete tip to fix that exact mistake next time — not a generic 'try again.' You see the score and the reasoning immediately, before your next turn." },
    { q: 'How is the AI tutor different from a scripted chatbot?',
      a: "The tutor builds its questions from your chosen language, your native language, and your stated proficiency level, then adjusts vocabulary and sentence complexity as the conversation goes — it's not a fixed decision tree. Grammar mistakes are corrected inline, in context, the moment they happen in the conversation, rather than saved for an end-of-lesson quiz." },
    { q: 'What happens to my mistakes after a session?',
      a: 'Words and phrases you get wrong are automatically added to your Wordbank as flashcards, so you review the specific things you actually struggled with — not a generic vocabulary list. Your Dashboard tracks session history over time, and a weekly report summarizes recurring grammar patterns so you can see what to work on next.' },
    { q: 'Is SpeakIQ better than Duolingo?',
      a: 'SpeakIQ focuses on real conversational fluency — you practice speaking and writing in full sentences with an AI tutor that responds to what you actually say, not drills with pre-set right answers. It\'s a complement to apps like Duolingo, not a replacement — use Duolingo for vocabulary drilling, SpeakIQ for the speaking practice most apps skip.' },
    { q: 'Do I need a headset or special equipment?', a: 'No — SpeakIQ works with your device\'s built-in microphone in any modern browser. There\'s no app to install and no hardware requirement beyond a working mic.' },
    { q: 'What are daily challenges and badges?',
      a: 'Each day SpeakIQ generates one focused challenge (a scenario, a grammar pattern, or a pronunciation drill) so you always have a specific starting point instead of a blank chat window. Badges track consistency — they unlock based on your actual session streak and completed challenges, not purchases.' },
    { q: 'What does Pro include?',
      a: "Pro gives you unlimited daily sessions (free tier is capped at 3/day), full grammar reports, roleplay scenarios, priority AI response speed, and the ability to export your flashcards and progress reports." },
    { q: 'Can I use SpeakIQ for interview or professional prep?',
      a: 'Yes — the conversation tutor supports roleplay scenarios (Pro), including professional contexts like job interviews, so you can practice the specific vocabulary and phrasing for a real situation, not just casual chat.' },
  ],
