/**
 * Feature flags — reads toggle_speakiq_* from Vercel Edge Config
...
export interface SiteFlags {
  pronunciation_score: boolean
  streak_widget: boolean
  speaking_challenges: boolean
  pricing: boolean
  chatbot: boolean
  freemium: boolean
  waitlist: boolean
