...
const brand: BrandConfig = {
  ...
  icon: '🗣️',
  color: '#f97316',
  url: 'https://speakfast.app',
  navLinks: [{ label: 'Start learning', href: '/' }, { label: 'Languages', href: '/?tab=languages' }],
...
export const metadata: Metadata = {
  ...
  openGraph: { title: 'SpeakFast — AI Language Learning', description: 'Conversational AI language tutor for rapid progress.', type: 'website', locale: 'en_GB', siteName: 'SpeakFast' },
  twitter: { card: 'summary_large_image', title: 'SpeakFast', description: 'AI language learning app.' },
    ...
    <html lang="en">
      <head>
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
          ...
          "name": "SpeakFast", "url": brand.url, "description": brand.tagline,
